"""hexaforge_slm_training_master_decision_hexa.port_xi — primary input"""
from fastapi import APIRouter, HTTPException
from pydantic import ValidationError
from src.shared.contracts import HexaforgeSlmTrainingMasterDecisionHexaXiSchema
...
router = APIRouter(prefix="/hexaforge_slm_training_master_decision_hexa/port-xi")
...
async def receive_xi(payload: dict):
    ...
    validate_contract(node_id="hexaforge_slm_training_master_decision_hexa", port="xi", payload=validated.model_dump())
    log_event(node_id="hexaforge_slm_training_master_decision_hexa", port="xi", payload=validated.model_dump())
