"""hexaforge_slm_training_master_packager_hexa.port_xi — primary input"""
from fastapi import APIRouter, HTTPException
from pydantic import ValidationError
from src.shared.contracts import HexaforgeSlmTrainingMasterPackagerHexaXiSchema
...
router = APIRouter(prefix="/hexaforge_slm_training_master_packager_hexa/port-xi")
...
async def receive_xi(payload: dict):
    ...
    validate_contract(node_id="hexaforge_slm_training_master_packager_hexa", port="xi", payload=validated.model_dump())
    log_event(node_id="hexaforge_slm_training_master_packager_hexa", port="xi", payload=validated.model_dump())
